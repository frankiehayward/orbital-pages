...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('smtp.gmail.com', 587, 'tls')
	  ->setUsername('frankie@catalystsquared.com')     
	  ->setPassword('munchie1378')
	  ;
	...
	$message = Swift_Message::newInstance('A new lead from Virtual Assistant landing page')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('frankie@catalystsquared.com' => 'Frankie Hayward'))->setBody($messageText);
//                           ^                    ^
